    ...
    return (
        <div className='card'>
            ...
            <div className='card-body'>
                ...
                <Button disabled={props.tasks.priority === props.prioritys[props.prioritys.length-1]} outline color="info" onClick={() => props.priorityChange(props.tasks._id,props.tasks.priority + 1)}>↑</Button>
                <Button disabled={props.tasks.priority === props.prioritys[0]} outline color="info" onClick={() => props.priorityChange(props.tasks._id,props.tasks.priority -1)}>↓</Button>
                </h6>
                <p>{props.tasks.description}</p>
                <p>{props.tasks.status}</p>
                {props.tasks.status !== 'todo' &&
                <a className="btn btn-primary" href="#" role="button"
                   onClick={() => props.moveTaskLeftRight(props.tasks._id, -1)}>←</a>
                }
